...
class Decoder(nn.Module):
    ...
    def forward(self, image_features, lidar_features, target_point, velocity, command):
        ...
        x = torch.cat([image_features, lidar_features, velocity, target_point, command, predict_features, control_features], dim=1)
        x = x + self.pos_emb
