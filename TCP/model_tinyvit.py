...
from tinyvit import TinyViT, PatchMerging,  model_cfg_big, model_cfg_small
...
class Encoder(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.config = config
        self.n_view = 2
        self.f_image_encoder = TinyViT(in_chans=3, **model_cfg_big)
        self.lr_image_encoder = TinyViT(in_chans=3, **model_cfg_small)
        ...
        self.cross_attn_f4 = CrossTransformerBlock(192, 192, n_head=8)
        ...
        self.cross_attn_lr4 = CrossTransformerBlock(192, 192, n_head=8)

        self.downsample1 = PatchMerging([8,8], 192, 192, nn.ReLU)
        self.downsample2 = PatchMerging([8,8], 192, 192, nn.ReLU)
    ...
    def forward(self, f_image_list, lr_image_list):
        ...
        f_image_features = self.f_image_encoder.layers[0](f_image_features)
        lr_image_features = self.lr_image_encoder.layers[0](lr_image_features)
        ...
        f_image_features = self.f_image_encoder.layers[1](f_image_features)
        lr_image_features = self.lr_image_encoder.layers[1](lr_image_features)
        ...
        f_image_features = self.f_image_encoder.layers[2](f_image_features)
        lr_image_features = self.lr_image_encoder.layers[2](lr_image_features)
        ...
        f_image_features = self.f_image_encoder.layers[3](f_image_features)
        lr_image_features = self.lr_image_encoder.layers[3](lr_image_features)
        f_image_features_cross = self.cross_attn_f4(lr_image_features, f_image_features)
        lr_image_features_cross = self.cross_attn_lr4(f_image_features, lr_image_features)
        f_image_features = f_image_features_cross
        lr_image_features = lr_image_features_cross

        f_image_features = self.downsample1(f_image_features)
        lr_image_features = self.downsample2(lr_image_features)
